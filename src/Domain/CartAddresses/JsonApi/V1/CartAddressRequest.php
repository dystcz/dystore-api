...
class CartAddressRequest extends AddressRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'contact_email.required' => __('dystore::validations.cart_addresses.contact_email.required'),
            'contact_email.string' => __('dystore::validations.cart_addresses.contact_email.string'),
            'contact_phone.required' => __('dystore::validations.cart_addresses.contact_phone.required'),
